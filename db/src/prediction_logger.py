...
def log_prediction(predicted_digit: int, confidence_score: float, true_label: int):
    """
    ...
    try:
        ...
        logger.info("Logged prediction: %s, %s, %s", predicted_digit, confidence_score, true_label)
